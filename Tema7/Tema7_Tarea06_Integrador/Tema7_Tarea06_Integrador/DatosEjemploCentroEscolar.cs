...
namespace Tema7_Tarea06_Integrador
{
    public static class DatosEjemploCentroEscolar
    {
        public static void DatosEjemploAlumnos(ListaAlumnos listaAlumnos)
        {
            ...
            listaAlumnos.AddAlumno(new("Lito", 34, "45651387H", 1));
            ...
            listaAlumnos.AddAlumno(new("Marina", 28, "98563240J", 1));
            ...
            listaAlumnos.AddAlumno(new("Lidia", 38, "48974231I", 1));
            ...
            listaAlumnos.AddAlumno(new("Carlos", 51, "21321836P", 1));
            ...
            listaAlumnos.AddAlumno(new("Kathy", 25, "88475621S", 1));
            ...
            listaAlumnos.AddAlumno(new("Lina", 45, "87451321M", 1));
            ...
            listaAlumnos.AddAlumno(new("Pedro", 20, "00215463L", 1));
            ...
            listaAlumnos.AddAlumno(new("David", 48, "05489135Z", 1));
            ...
            listaAlumnos.AddAlumno(new("Nika", 18, "54562188F", 1));
            ...
            listaAlumnos.AddAlumno(new("Juan Manuel", 22, "41218435Y", 1));
            ...
            listaAlumnos.AddAlumno(new("Juanjo", 56, "31518898C", 1));
            ...
            listaAlumnos.AddAlumno(new("Marta", 27, "44582339V", 1));
            ...
            listaAlumnos.AddAlumno(new("Luna Camila", 33, "22217875B", 1));
            ...
            listaAlumnos.AddAlumno(new("Victoria", 40, "08723614A", 1));
