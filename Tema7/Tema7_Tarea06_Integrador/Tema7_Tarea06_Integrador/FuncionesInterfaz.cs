    ...
    public static class FuncionesInterfaz
    {
        ...
        public static int LeerCodigoCurso(string mensaje)
        {
            ...
            do
            {
                ...
                if (esCorrecto && (num != -1 && (num < 100 || num > 200)))
                {
                    MessageBox.Show("El código tiene que estar en el rango o ser -1.");
                }

            } while (!esCorrecto || (num != -1 && (num < 100 || num > 200)));
        ...
        public static string LeerNombre(string mensaje)
        {
            ...
            do
            {
                                                         ...
                                                         * con un array (vector) de caracteres. */
                {
                    ...
                    // Aquí miramos si el nombre después del espacio es válido, devolviendo false si no lo es.
